  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route
          exact
          path="/faculty/addnoticeboard"
          element={<AddNoticeBoard />}
        />
        <Route
          exact
          path="/faculty/viewnoticeboard"
          element={<ViewNoticeBoard />}
        />
        <Route exact path="/faculty/viewstudent" element={<ViewStudent />} />
        <Route
          exact
          path="/faculty/addassignment"
          element={<UploadAssignment />}
        />
        <Route
          exact
          path="/faculty/viewassignment"
          element={<ViewAssignment />}
        />
        <Route
          path="/faculty/viewassignmentanswer"
          element={<AssignmentAnswer />}
        />
        <Route
          path="/faculty/editnoticeboard/:id"
