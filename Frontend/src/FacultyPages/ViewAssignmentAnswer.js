  ...
  useEffect(() => {
    const fetchanswers = async () => {
      try {
        ...
        const url = `http://localhost:8080/faculty/viewassignmentanswer/${sessionStorage.getItem(
          "userId"
        )}`;
      ...
      <div className="cotainer-fluid">
        ...
        >
          <div className="col-8 p-5 shadow bg-white">
            <center>
              <span>
                <h1>View Assignment Answers</h1>
              </span>
            </center>
            <div className="ui icon input">
              <input
                type="text"
                placeholder="Enter Module or student name"
                className="prompt"
                name="searchText"
                      ...
                      <td>
                        ...
                        <td>
                          <input
                            ...
                            onChange={(e) => getRemark(e)}
                          />
                          <button
                            className="button muted-button"
                            onClick={() => handleRemark(id)}
                          >
                            Remark
                          </button>
                        </td>
